...
- **Usage**: Retrieve account-level usage and quota information: emails, contacts, segments, broadcasts, AI credits, automation runs, domains, and the API rate limit.
